...
export default function Table(props) {
    ...
    return (
        <div className="table-card" >
            {
                props.roster &&
                < DataTable className={"table " + props.className} value={props.roster["roster"]} header={(props.roster.staffType).toUpperCase()} headerClassName="assignment-label" responsiveLayout="scroll"
